...
public class CashAccount16 {
    ...
    public static CashAccount16 instance(String iban) {
        //TODO sprawdzac dlugosc i skłąd iban
        CashAccount16 cashAccount = new CashAccount16();
        AccountIdentification4Choice aic = new AccountIdentification4Choice();
        aic.setIBAN(iban);
        cashAccount.setId(aic);
        return cashAccount;
    }  
    
    @Override
    public CashAccount16 clone() {
        //TODO a może new String(this.getId().getIBAN())
        return CashAccount16.instance(this.getId().getIBAN());
    }    
}
